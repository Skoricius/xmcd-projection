...
Example code where the mesh is in ``example_mesh.msh`` file and magnetization data in ``mag_file.csv``. 
The latter can be generated by opening the simulation in Paraview_ and going to Save Data... and exporting to .csv
